...
- (void)viewWillLayoutSubviews
{
    ...
    [self.valueLabel topInContainer:[self.view safeAreaTopGap]+44+70 shouldResize:NO];
    ...
    self.returnButton.ct_size = CGSizeMake(100, 28);
    [self.returnButton bottomInContainer:[self.view safeAreaBottomGap] shouldResize:NO];
